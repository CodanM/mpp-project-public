...
namespace client_wpf_remoting
{
    public partial class RegistrationWindow : Window
    {
        ...
        public RegistrationWindow(ContestMgmtClientController controller, MainWindow mainWindow)
        {
            ...
            Dispatcher.BeginInvoke(new Action(() => CompetitionTypeComboBox.ItemsSource = _competitionTypes));
        }
        ...
        private void UpdateAgeCategories()
        {
            ...
            Dispatcher.BeginInvoke(new Action(() => AgeCategoryComboBox.ItemsSource = _ageCategories));
        }
        ...
        private void IdComboBox_DropDownOpened(object sender, EventArgs e)
        {
            ...
            Dispatcher.BeginInvoke(new Action(() => IdComboBox.ItemsSource = ids));
        }
